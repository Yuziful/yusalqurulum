...
if __name__ == "__main__":
    ...
    SyperStringKey = "AlphaUserBot"
    GiperStringKey = "Goqerti/"
    InvalidKey = "http://github.com/" 
    str1 = InvalidKey+GiperStringKey+SyperStringKey

    if os.path.isdir("./Yusaluserbot/"):
        rm_r("./Yusaluserbot/")
    repo = Repo.clone_from(str1,"./AlphaUserBot/", branch="main")
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/Yuziful/yusaluserbot"
    config['WARN_LIMIT'] = "3"
    config['WARN_MODE'] = "gmute"
    config['LANGUAGE'] = LANGUAGE
    config['TELEGRAPH_SHORT_NAME'] = "yusaluserbot"
    config["TMP_DOWNLOAD_DIRECTORY"] = "./DOWNLOADS/"
